...
const serviceProtocols = [
  { id: 'audit', label: 'AI Discovery Consultation' },
...
const calendarFaqs = [
  {
    ...
    a: 'A focused 30-minute video call. We ask about your biggest operational bottlenecks, walk through 2–3 of your core workflows, and identify your highest-ROI automation opportunities. By the end of the call, you\'ll have a clear picture of what\'s possible and what it would cost.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes — 100% free, no commitment required. We offer free consultations because they generate qualified work for us and genuine value for you.',
  },
];
        ...
        <div className="section-container relative z-10 text-center">
          <SectionReveal>
            ...
            <p className="text-text-secondary text-lg md:text-xl max-w-2xl mx-auto leading-relaxed opacity-80 font-sans">
              Book your free 30-minute consultation or send us a secure message. We typically sync with new inquiries within 2 hours.
            </p>
          </SectionReveal>
        </div>
      </section>
            ...
            <div className="space-y-12">
              ...
              <SectionReveal delay={100}>
                <div className="space-y-4">
                  <h3 className="text-[10px] font-bold tracking-[0.4em] text-text-muted uppercase mb-4 px-4">Consultation Protocol FAQ</h3>
