...
import { Clock, CheckCircle, ChevronDown, ChevronUp, Zap, Calendar, MessageSquare, ArrowRight, ShieldCheck, Mail, Phone } from 'lucide-react';
...
export default function ContactPage() {
  ...
  useEffect(() => {
    if (preselectedService) {
      // Find the label matching the ID if possible
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('SYNC_ERROR:', await response.text());
