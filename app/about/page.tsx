...
const team = [
  ...
  {
    name: 'Automation Engineer 04',
    role: 'Lead Automation Engineer',
    bio: 'Certified automation expert. 180+ workflows built. Specialises in CRM integrations and healthcare automation.',
    gradient: 'from-white/10 to-accent-blue/40',
    initials: 'ENG',
  },
  {
    name: 'Solutions Specialist 02',
    role: 'AI Solutions Specialist',
    bio: 'LLM fine-tuning and prompt engineering specialist. Previously built AI products at leading design platforms. Expert in custom GPTs.',
    gradient: 'from-accent-blue/20 to-accent-blue/60',
    initials: 'SOL',
  },
  {
    name: 'Operations Lead 07',
    role: 'Client Success Lead',
    bio: 'Operations background from scaling large-scale logistics companies. Translates business problems into automation briefs with 100% accuracy.',
    gradient: 'from-accent-blue/10 to-white/5',
    initials: 'OPS',
  },
];
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background pt-20 overflow-hidden">
      ...
      {/* Team Section - Background infrastructure team placeholder */}
      {/* 
      <section className="py-32 relative overflow-hidden">
        <div className="absolute top-1/2 left-0 w-96 h-96 bg-accent-blue/5 rounded-full blur-[100px] pointer-events-none" />
        <div className="section-container relative z-10">
          <SectionReveal className="text-center mb-24">
            <div className="tech-badge rounded-full mb-6 mx-auto">CORE INFRASTRUCTURE TEAM</div>
            <h2 className="text-2xl md:text-4xl font-sans font-bold text-text-primary tracking-tight leading-tight">Engineers At Heart.</h2>
          </SectionReveal>
        </div>
      </section>
      */}
