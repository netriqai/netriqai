...
const checklistItems = [
  'Map your top 10 most time-consuming workflows',
  'Identify data entry tasks that repeat daily or weekly',
  'Find tools that don\'t currently integrate',
  'Calculate your manual task cost per month',
  'Assess your team\'s digital literacy baseline',
  'Identify compliance-critical processes',
  'Evaluate your data quality and accessibility',
  'Define your top 3 automation ROI targets',
];
...
export default function ResourcesPage() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-background">
      {/* Hero Section - Industrial Blueprint Feel */}
      ...
      {/* Blog Posts - Resource Tiles */}
      <section className="py-24 bg-surface-2/30">
        <div className="section-container">
          <SectionReveal className="mb-16">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <p className="text-text-muted max-w-sm text-sm font-mono uppercase opacity-60">
                Filter by architecture, industry, or strategic automation focus.
              </p>
            </div>
          </SectionReveal>
            ...
            <div className="max-w-3xl mx-auto text-center bg-surface-1 border border-border-strong rounded-[32px] p-10 md:p-20 shadow-2xl">
              ...
              {newsletterSubmitted ? (
                ...
                <>
                  ...
                  <p className="text-text-muted text-[10px] mt-6 font-mono uppercase opacity-40">
                    Proprietary insights for Australian SMBs. unsubscribe at any terminal.
                  </p>
                </>
              )}
            </div>
