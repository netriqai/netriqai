...
import { TrendingUp, Zap, MapPin, ArrowRight } from 'lucide-react';
...
const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    headline: 'Customer support AI + returns automation',
    metric: '78%',
    metricLabel: 'tickets deflected by AI',
    challenge:
      'A fast-growing NZ e-commerce brand was receiving 800+ support tickets per week. Support team of 4 was overwhelmed. Response times blew out to 48+ hours. Customer satisfaction was declining fast.',
    solution:
      'Deployed an AI support agent trained on product catalogue, return policies, FAQs, and order history. Handles order status, returns, exchanges, sizing queries, and product questions autonomously. Escalates complex issues to humans.',
    result: '78% of tickets now resolved by AI without human involvement. Response time: 48 hours → under 2 minutes. CSAT improved from 3.2 to 4.7/5. Support team now handles complex issues only — no burnout.',
    tools: ['Relevance AI', 'Gorgias', 'Shopify', 'Slack', 'Make.com'],
    quote: 'Our support AI is genuinely better than our old team at handling returns and order queries. Customers are happier and my team is finally not burnt out.',
    quoteAuthor: 'Founder, Auckland E-commerce Brand',
  },
];
        ...
        <div className="section-container relative z-10 text-center">
          <SectionReveal>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[rgba(var(--accent-blue),0.3)] bg-background/50 backdrop-blur-md mb-8">
              ...
              <span className="text-[9px] font-black tracking-[0.3em] text-[rgb(var(--accent-blue))] uppercase">Architecture_Reports_v2.0</span>
            </div>
            ...
            >
              Real World <br/>
              <span className="text-[rgb(var(--accent-blue))]">Architecture.</span>
            </h1>
            <p className="text-text-muted text-lg md:text-xl max-w-2xl mx-auto leading-relaxed opacity-80">
              Concrete evidence of neural automation driving ROI for Australian SMBs. Engineered for precision, delivered at scale.
            </p>
          </SectionReveal>
        </div>
      </section>
      ...
      <section className="py-40 bg-background relative overflow-hidden text-center border-t border-border-strong">
        ...
        <div className="section-container relative z-10">
          <SectionReveal>
            ...
            <p className="mt-8 text-[10px] font-mono text-text-muted uppercase tracking-widest opacity-40">
              * Average identification of 120+ hours of monthly reclaimed capacity.
            </p>
          </SectionReveal>
        </div>
      </section>
