...
const caseStudies = [
  {
    ...
    metric: '67%',
    metricLabel: 'reduction in support tickets in 21 days',
    ...
    result: 'AUD $180,000 saved annually. Admin team redeployed to patient care.',
    color: '#06B6D4',
  },
  {
    industry: 'E-commerce',
    ...
    metric: 'AUD $240k',
    metricLabel: 'saved in Year 1 through inventory automation',
    problem: 'Overstocking and stockouts were costing $20k/month. Manual supplier ordering was error-prone.',
    ...
    result: '99.2% stock availability. Stockout costs eliminated. $240k net saving in Year 1.',
    color: '#4ADE80',
  },
  {
